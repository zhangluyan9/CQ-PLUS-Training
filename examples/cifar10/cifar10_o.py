...
class AddQuantization(object):
    ...
    def __call__(self, tensor):
        ...
        return torch.div(torch.floor(torch.mul(tensor, 600.0)), 600.0)
...
def main():
    ...
    parser.add_argument('--T', type=int, default=600, metavar='N',
    ...
    train_loader = torch.utils.data.DataLoader(
       trainset, batch_size=512+256+512, shuffle=True)
    ...
    snn_dataset = SpikeDataset(testset, T = args.T,theta = 0.999)
    ...
    model.load_state_dict(torch.load("vggo_9515.pt"), strict=False)
    #relu: vggo_9515_keeptraining_cq_3.pt/0301_cq_wopretrain_relu
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if correct>correct_:
            correct_ = correct
            #vggo_9515_keeptraining_wo_pretrain_1_
            torch.save(model.state_dict(), "0301_cq_wopretrain_relu.pt")
        scheduler.step()
