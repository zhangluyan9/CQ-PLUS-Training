    ...
    def _make_layers(self, cfg):
        ...
        for x in cfg:
            if x == 'M':
                ...
                layers += [nn.Conv2d(in_channels, out_channels, kernel_size=3, padding=padding, bias=True),nn.BatchNorm2d(out_channels), catSNN.Clamp_q(max = self.clamp_max,q_level=T_s),nn.Dropout2d(0.15)]
