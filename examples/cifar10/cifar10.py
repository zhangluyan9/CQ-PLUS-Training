...
class AddQuantization(object):
    ...
    def __call__(self, tensor):
        ...
        return torch.div(torch.floor(torch.mul(tensor, 1000.0)), 1000.0)
...
def main():
    ...
    snn_dataset = SpikeDataset(testset, T = args.T,theta = 0.99)
    snn_loader = torch.utils.data.DataLoader(snn_dataset, batch_size=50, shuffle=False)
